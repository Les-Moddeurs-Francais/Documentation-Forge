...
Dans cette section, nous allons voir comment générer nos différentes [recettes](/bases/resources/recipe.mdx) à l'aide d'un générateur.
...
en pioche en fer à l'aide d'un lingot de fer et d'un bloc de diamant (parce que pourquoi pas). Ici aussi, c'est
assez simple :
...
Le premier argument représente l'item _modèle_, le deuxième
représente l'item que vous souhaitez améliorer, le troisième l'item nécessaire à l'amélioration (ce que pourrait appeler le matériau), le quatrième la catégorie de la recette et enfin le dernier, le résultat.

...
import newTemplate from '../../../static/img/docs/gametest_new_template.png';
import hopperTemplate from '../../../static/img/docs/gametest_template_hopper.png';
...
:::info
Pensez à bien remplacer `votre_mod_id` par celui de votre mod (attention, ce dernier est présent plusieurs fois dans le fichier `build.gradle`)
...
<Image alt="Modèle de test vide" img={newTemplate} />
...
<Image alt="Modèle de test avec un hopper" img={hopperTemplate} />

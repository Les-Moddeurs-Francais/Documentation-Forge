...
| `decorated_port_shared`        | Liste de tous les types de tessons permettant de décorer des vases décorés                       |
...
| `smelts_to_glass`              | Liste des blocs qui peuvent être cuits pour obtenir du verre                                     |
| `sniffer_food`                 | Liste de tous les types nourritures pour le Renifleur                                            |

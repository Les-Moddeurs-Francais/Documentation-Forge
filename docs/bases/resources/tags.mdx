...
<Details summary={'Valeurs requises'}>
...
<Details summary={'Valeurs optionnelles'}>
...
<Details summary={'Liste des tags concernant les motifs de bannière'}>
...
<Details summary={'Liste des tags concernant les blocs'}>
...
<Details summary={'Liste des tags concernant les variantes de chat'}>
...
<Details summary={'Liste des tags concernant les entités'}>
...
<Details summary={'Liste des tags concernant les fluides'}>
...
<Details summary={'Liste des tags concernant les évènements de jeu'}>
...
<Details summary={'Liste des tags concernant les instruments'}>
...
<Details summary={'Liste des tags concernant les items'}>
...
| `breaks_decorated_pots`        | Liste de tous les types d'outils permettant de casser des pots décorés                           |
...
<Details summary={'Liste des tags concernant les variantes de peinture'}>
...
<Details summary={`Liste des tags concernant les variantes de points d'intérêt`}>
...
<Details summary={'Liste des tags concernant les biomes'}>
...
<Details summary={'Liste des tags concernant les générateurs de niveau plat préréglés'}>
...
<Details summary={'Liste des tags concernant les structures'}>
...
<Details summary={'Liste des tags concernant les préréglages du monde'}>
